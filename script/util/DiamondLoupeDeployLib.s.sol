...
library DiamondLoupeDeployLib {
    string public constant FACET_NAME = 'DiamondLoupeFacet';
    string public constant ENV_NAME = 'DIAMOND_LOUPE_FACET';
    ...
    /// @notice Attaches a DiamondLoupeFacet to a diamond
    ...
    /// @notice Removes the DiamondLoupeFacet from a Diamond
    function removeFacetFromDiamond(address diamond) internal {
        //  This is a custom implementation - the normal cutFacetOffOfDiamond uses
        //  the diamondLoupe methods for introspection, so we have to bypass and
        //  specify selectors directly
