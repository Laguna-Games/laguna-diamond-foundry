...
library SupportsInterfaceDeployLib {
    string public constant FACET_NAME = 'SupportsInterfaceFacet';
    string public constant ENV_NAME = 'SUPPORTS_INTERFACE_FACET';
    ...
    /// @notice Attaches a SupportsInterfaceFacet to a diamond
    ...
    /// @notice Removes the SupportsInterfaceFacet from a Diamond
